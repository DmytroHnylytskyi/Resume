 ...
 * @property {string} id - Unique UUID string for the placed object.
 * @property {string} modelPath - Relative file path to GLB asset in public/model/.
 * @property {[number, number, number]} position - 3D position vector [x, y, z] in meters.
 * @property {[number, number, number]} rotation - 3D rotation Euler angles [rx, ry, rz] in radians.
 * @property {number} scale - Unified scale multiplier factor.
 * @property {string[]} hiddenParts - List of sub-mesh node names hidden by user.
 * @property {Object.<string, string>} colors - Map of sub-mesh part names to hex color codes.
