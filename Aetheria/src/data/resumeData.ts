...
export const developerProfiles: Record<Locale, DeveloperProfile> = {
  uk: {
    ...
    bio: "Full-Stack інженер із фокусом на високопродуктивних веб-додатках, надійних асинхронних архітектурах та креативній 3D-графіці у браузері. Спеціалізуюся на створенні комплексних цифрових продуктів з нуля — від проєктування реляційних баз даних та відмовостійких API до 60 FPS WebGL-інтерфейсів та просторових 3D-конфігураторів.",
    summary: [
  ...
  en: {
    ...
    bio: "Full-Stack engineer specializing in high-performance web applications, resilient asynchronous architectures, and creative browser-based 3D graphics. Focused on building complete digital products from the ground up — from resilient database schemas and non-blocking APIs to 60 FPS WebGL interfaces and spatial 3D configurators.",
    summary: [
...
export const translations: Record<Locale, Translations> = {
  uk: {
    ...
    landing: {
      ...
      backToTop: "Догори",
      statProjects: "проєкти в портфоліо",
      statDisciplines: "напрями технологій",
      statCertifications: "сертифікати",
  ...
  en: {
    ...
    landing: {
      ...
      ctaText: "Let's build something fast, beautiful and technically solid — from database schema to WebGL client.",
      ctaButton: "Contact Me",
      copyEmail: "Copy Email",
      copied: "Copied!",
      downloadPdf: "Download PDF",
      backToTop: "Back to top",
      statProjects: "projects to explore",
      statDisciplines: "technology disciplines",
