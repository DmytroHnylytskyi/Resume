...
export const translations: Record<Locale, Translations> = {
  uk: {
    ...
    landing: {
      ...
      heroNameOutline: "Дмитро",
      heroNameSolid: "Гнилицький",
      ...
      projectsWatermark: "ПОРТФОЛІО",
      keyFeatures: "Ключові архітектурні фічі:",
      liveDemo: "Переглянути проєкт",
      sourceCode: "Вихідний код",
      realProjectBadge: "Реальний проєкт",
      interactiveBadge: "3D Світ",
  ...
  en: {
    ...
    landing: {
      ...
      heroNameOutline: "Dmytro",
      heroNameSolid: "Hnylytskyi",
      ...
      educationYears: "of software engineering study",
      ...
      projectsWatermark: "PORTFOLIO",
      keyFeatures: "Key Highlights:",
      liveDemo: "View Project",
      sourceCode: "Source Code",
      realProjectBadge: "Real Project",
      interactiveBadge: "3D World",
