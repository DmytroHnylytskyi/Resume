...
Цей репозиторій є монорепозиторієм із 4 повнофункціональних Full-Stack застосунків, що демонструють практичну експертизу в розробці сучасних веб-інтерфейсів, апаратно-прискореної 3D WebGL графіки, асинхронних бекенд-сервісів на Python/FastAPI та надійної архітектури додатків.
